...
SEGMENT_PROMPT_MESSAGES = [
    (
        "system",
        """You are a legal document parser. Your only job is to split a contract into its individual clauses.
...
- If a clause has no explicit heading, infer a short descriptive one (e.g. "Notice Period", "IP Assignment")
